...
#     def __init__(self, num_one: int, num_two: int) -> None:
#         self.num_one = num_one
#         self.num_two = num_two

#     def adding_two_numbers(self) -> int:
#         return self.num_one + self.num_two

#     def subtracting_two_numbers(self) -> int:
#         return self.num_one - self.num_two

#     def division_two_numbers(self) -> int:
#         return self.num_one / self.num_two

#     def multiplication_two_numbers(self) -> int:
#         return self.num_one * self.num_two

#     def power_two_numbers(self) -> int:
#         return self.num_one**self.num_two


# three_and_four = Math(3, 4)

# print(three_and_four.power_two_numbers())
...
# Create a Database management class that would setup all connections and implement CRUD opearations (inside class/classses). There should be a decorator that would handle possible errors. 
